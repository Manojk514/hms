...
window.goBackHome = () => (window.location.href = "index.html");
window.goAppointments = () =>
  (window.location.href = "admin_appointments.html");
window.goLabAnalytics = () =>
  (window.location.href = "admin_lab_analytics.html");
window.goPatients = () => (window.location.href = "admin_patients.html");
window.goDoctors = () => (window.location.href = "admin_doctors.html");
window.goStaff = () => (window.location.href = "admin_staff.html");
...
window.showAppointments = () => {
  ...
  document.getElementById("labsTab").classList.remove("active");
};

window.showLabs = () => {
  document.getElementById("appointmentsTable").style.display = "none";
  document.getElementById("labsSection").style.display = "table";

  document.getElementById("appointmentsTab").classList.remove("active");
  document.getElementById("labsTab").classList.add("active");
